...
class EBNF_to_BNF(Transformer_InPlace):
    print("load_grammar.py, EBNF_to_BNF")
    def __init__(self):
        print("load_grammar.py, EBNF_to_BNF, init")
        self.new_rules = []
        self.rules_by_expr = {}
        self.prefix = 'anon'
        self.i = 0
    ...
    def _add_recurse_rule(self, type_, expr):
        print("load_grammar.py, EBNF_to_BNF, add recurse rule")
    ...
    def expr(self, rule, op, *args):
        print("load_grammar.py, EBNF_to_BNF, expr")
...
class SimplifyRule_Visitor(Visitor):
    print("load_grammar.py, symplify rule visitor")
    ...
    def alias(self, tree):
        print("load_grammar.py, symplify rule visitor, alias")
...
class RuleTreeToText(Transformer):
    print("load_grammar.py, rule tree to text")
...
class CanonizeTree(Transformer_InPlace):
    print("load_grammar.py, canonize tree")
...
class PrepareAnonTerminals(Transformer_InPlace):
    print("load_grammar.py, prepare anon terminals")
