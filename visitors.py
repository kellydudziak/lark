...
class Discard(Exception):
    print("visitors.py, discard")
    pass

# Transformers

class _Decoratable:
    print("visitors.py, decoratable")
    @classmethod
...
class InlineTransformer(Transformer):   # XXX Deprecated
    print("visitors.py, inline transformer")
    def _call_userfunc(self, tree, new_children=None):
        # Assumes tree is already transformed
        children = new_children if new_children is not None else tree.children
        try:
...
class TransformerChain(object):
    print("visitors.py, transformer chain")
...
class Transformer_InPlace(Transformer):
    print("visitors.py, transformer in place")
...
class Transformer_NonRecursive(Transformer):
    print("visitors.py, transformer non recursive")
...
class Transformer_InPlaceRecursive(Transformer):
    print("visitors.py, transformer in place recursive")
...
class VisitorBase:
    print("visitors.py, visitor base")
...
class Visitor_Recursive(VisitorBase):
    print("visitors.py, visitor recursive")
...
def visit_children_decor(func):
    print("visitors.py, visit children decor")
    "See Interpreter"
    @wraps(func)
    def inner(cls, tree):
...
class CollapseAmbiguities(Transformer):
    print("visitors.py, collapse ambiguities")
    """
